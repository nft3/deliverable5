...
public class MainPanel extends JPanel {
    ...
    // This method is horribly written. There can be some refactoring done here.
    /*
    private int convertToInt(int x) {
        // We are just padding 1000 zeros to the front of the value of x.
        // Then we are parsing it and returning it as an int. So why do we
    ...
    /* public void runContinuous() {
        ...
        while (_running) {
            ...
            // What is the purpose of this if we immediately just set _r back
            // to origR once this loop is completed?
    ...
    // Refactored without the for loop
    public void runContinuous() {
        _running = true;
        while (_running) {
            System.out.println("Running...");
